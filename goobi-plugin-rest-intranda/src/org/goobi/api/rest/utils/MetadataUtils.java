...
public class MetadataUtils {
	...
	private static final XPathExpression<Element> authorityMetaXpath = xFactory.compile("//mets:xmlData/mods:mods/mods:extension/goobi:goobi/goobi:metadata", 
	...
	private static RestProcess addMetadataToRestProcess(RestProcess p, String metadataFolder, SearchRequest req, Map<String, Map<String, String>> labelMap) {
	    ...
	    extractMetadataFromFile(metsPath, p, labelMap);
	    extractMetadataFromFile(anchorPath, p, labelMap);
		return p;
	}

	private static void extractMetadataFromFile(Path metsPath, RestProcess p, Map<String, Map<String, String>> labelMap) {
		Document doc;
